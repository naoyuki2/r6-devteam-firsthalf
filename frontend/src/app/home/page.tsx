      ...
      >
        <div className="border-bottom border-opacity-25">
          <div className="d-flex">
            <PersonCircle size={36} className="me-3" />
            <span className="fw-bold my-2">平山海翔</span>
            <span className="ms-auto my-2">2024/10/09 10:38</span>
          </div>
          <p className="fw-bold mb-2">
            東京ドームのフェス限定のグッズが欲しい！
          </p>
          <p className="text-truncate mb-2"></p>
