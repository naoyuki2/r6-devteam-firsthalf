...
export class AddCreated1727233298030 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "item" RENAME COLUMN "userId" TO "requestId"`);
        ...
        await queryRunner.query(`ALTER TABLE "item" ADD CONSTRAINT "FK_19c0b0b720d5f41b9b0abf35da4" FOREIGN KEY ("requestId") REFERENCES "request"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "item" DROP CONSTRAINT "FK_19c0b0b720d5f41b9b0abf35da4"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "updated_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "item" RENAME COLUMN "requestId" TO "userId"`);
